...
urlpatterns = [
    ...
    path('post_damage/<int:pk>',views.PostDelete.as_view(),name = 'post_delete'),
    ...
    path('subcategory_list',views.SubCategoryList.as_view(),name ='subcategory_list'),
    path('ategory_detail/<str:name_en>',views.CategoryDetail.as_view(),name ='category_detail'),
    path('search',views.Search,name='search'),#searchのpathを追加
    ]